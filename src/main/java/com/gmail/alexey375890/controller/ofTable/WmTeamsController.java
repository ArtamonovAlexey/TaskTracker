...
public class WmTeamsController {
    ...
    public WmTeams putPersonById(
            ...
            @RequestBody Long newPersonId
    ) {
        return wmTeamsService.updatePerson(id, newPersonId);
    }
    ...
    public WmTeams putDevelopById(
        ...
        return wmTeamsService.updateTeam(id, newDevelopId);
    }
    ...
    public WmTeams nSaveTeamById(
            @Parameter(description = "Добавляемая в базу данных компания")
            @PathVariable Long id
    ) {
        return wmTeamsService.nSave(id);
    }
